...
**현재 상태**: Phase 3 전체 완료 (파일 작업)
**다음 단계**: Phase 4 - 단축키 시스템 리팩토링 (Vim 스타일)
...
|---------|--------|------|-----------|
| 탐색 | `j`/`k` | 커서 아래/위 | ↑/↓ |
| | `h`/`l` | 상위 디렉토리/진입 | ←/Enter |
| | `gg`/`G` | 맨 위/맨 아래 | Home/End |
| | `Ctrl+U`/`Ctrl+D` | 반 페이지 위/아래 | PageUp/PageDown |
| 파일 조작 | `y` | 복사 | F5 |
| | `x` | 이동 | F6 |
| | `d` | 삭제(휴지통) | F8 |
| | `D` | 영구 삭제 | - |
