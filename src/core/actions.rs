...
pub static ACTION_DEFS: &[ActionDef] = &[
    ...
    ActionDef {
        action: Action::TabSwitch1,
        id: "tab_1",
        label: "Tab 1",
        category: ActionCategory::Tab,
        shortcut_display: Some("t1"),
        command_bar: None,
    },
    ActionDef {
        action: Action::TabSwitch2,
        id: "tab_2",
        label: "Tab 2",
        category: ActionCategory::Tab,
        shortcut_display: Some("t2"),
        command_bar: None,
    },
    ActionDef {
        action: Action::TabSwitch3,
        id: "tab_3",
        label: "Tab 3",
        category: ActionCategory::Tab,
        shortcut_display: Some("t3"),
        command_bar: None,
    },
    ActionDef {
        action: Action::TabSwitch4,
        id: "tab_4",
        label: "Tab 4",
        category: ActionCategory::Tab,
        shortcut_display: Some("t4"),
        command_bar: None,
    },
    ActionDef {
        action: Action::TabSwitch5,
        id: "tab_5",
        label: "Tab 5",
        category: ActionCategory::Tab,
        shortcut_display: Some("t5"),
        command_bar: None,
    },
    ActionDef {
        action: Action::TabSwitch6,
        id: "tab_6",
        label: "Tab 6",
        category: ActionCategory::Tab,
        shortcut_display: Some("t6"),
        command_bar: None,
    },
    ActionDef {
        action: Action::TabSwitch7,
        id: "tab_7",
        label: "Tab 7",
        category: ActionCategory::Tab,
        shortcut_display: Some("t7"),
        command_bar: None,
    },
    ActionDef {
        action: Action::TabSwitch8,
        id: "tab_8",
        label: "Tab 8",
        category: ActionCategory::Tab,
        shortcut_display: Some("t8"),
        command_bar: None,
    },
    ActionDef {
        action: Action::TabSwitch9,
        id: "tab_9",
        label: "Tab 9",
        category: ActionCategory::Tab,
        shortcut_display: Some("t9"),
        command_bar: None,
    },
    // About
    ActionDef {
